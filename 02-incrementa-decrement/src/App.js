...
function App() {
  ...
  return (
    <div className='bg-red-600 flex justify-center items-center h-screen select-none flex-col gap-4'>
      <div className='bg-green-600 space-x-6 px-10 py-5 flex items-center'>
      ...
      <div className='bg-green-600  px-10 py-3 rounded flex items-center'>
